import { LayoutDashboard, LogOut, X, Users, Table2, Contact } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { path: "/admin/table", label: "Table", icon: Table2 },
  { path: "/admin/contact", label: "Contact", icon: Contact },
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const handleLogout = async () => {
    try {
      await axios.get(
        "https://food-backend-gf5l.onrender.com/api/auth/logout",
        {
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-md font-extrabold tracking-tight leading-tight">FOOD PARK</p>
            </div>
          </div>
